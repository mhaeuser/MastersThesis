...
In this section, we will present machine code generated for different types of bit field decoding. In general, shift-based bit field decoding generates smaller code compared to mask-based bit field decoding. Feature flag decoding is well-optimized across compilers and architectures.
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:mask_dec} (x86-64).}
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:mask_dec} (ARM64).}
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:mask_dec} (RISC-V).}
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:shift_dec} (x86-64).}
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:shift_dec} (ARM64).}
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:shift_dec} (RISC-V).}
...
\clearpage
\FloatBarrier
\subsection{Feature Flag Decoding and Compiler Optimizations}

In this section, we will present machine code generated for feature flag decoding.

\begin{lstfloat}[!htb]
  \centering
  \caption{Feature Flag Decoding.}
  \label{lst:ff_dec}
  \begin{lstlisting}[style=c]
int main(void) {
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:ff_dec} (x86-64).}
  \caption*{
    \begin{tabular}{r l}
      \textbf{Compiler:} & x64 msvc v19.33\\
      \textbf{Compiler Options:} & /O2\\
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:ff_dec} (ARM64).}
  \caption*{
    \begin{tabular}{r l}
      \textbf{Compiler:} & ARM64 gcc 12.2\\
      \textbf{Compiler Options:} & -O3\\
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:ff_dec} (RISC-V).}
  \caption*{
    \begin{tabular}{r l}
      \textbf{Compiler:} & RISC-V rv64gc clang 15.0.0\\
      \textbf{Compiler Options:} & -O3\\
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Shift-Assisted Feature Flag Decoding.}
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:ff_shift_dec} (x86-64).}
  \caption*{
    \begin{tabular}{r l}
      \textbf{Compiler:} & x64 msvc v19.33\\
      \textbf{Compiler Options:} & /O2\\
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:ff_shift_dec} (ARM64).}
  \caption*{
    \begin{tabular}{r l}
      \textbf{Compiler:} & ARM64 gcc 12.2\\
      \textbf{Compiler Options:} & -O3\\
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{lst:ff_shift_dec} (RISC-V).}
  \caption*{
    \begin{tabular}{r l}
      \textbf{Compiler:} & RISC-V rv64gc clang 15.0.0\\
      \textbf{Compiler Options:} & -O3\\
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{fig:local_sym} (x86-64).}
  \caption*{
    \begin{tabular}{r l}
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{fig:local_sym} (ARM).}
  \caption*{
    \begin{tabular}{r l}
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{fig:local_sym} (ARM64).}
  \caption*{
    \begin{tabular}{r l}
      \textbf{Compiler:} & ARM64 gcc 12.2\\
...
\begin{lstfloat}[!htb]
  \centering
  \caption{Machine Code for Source Code~\ref{fig:local_sym} (RISC-V).}
  \caption*{
    \begin{tabular}{r l}
...
\FloatBarrier
\chapter{UEFI Executable File Format Specification}

This appendix contains a draft for the specification of the \glsfirst{UE} format~\cite{thesis-git}.
...
\begin{table}[!htb]
  ...
  \begin{tabularx}{\textwidth}{l X}
    ...
    Bits 63:60 & The shift exponent, offset by $-12$, for the \glsxtrshort{UE} segment alignment in bytes.\\
    \midrule
...
\FloatBarrier
\chapter{UEFI Executable File Format Space-Saving}

This appendix contains the space-saving reports for converting all modules of \gls{OVMF} and \gls{ArmVirtQemu} from \glsxtrshort{PE} to \glsxtrshort{UE}. It was generated by a custom script and is publicly available and reproducible for artifact evaluation~\cite{thesis-git}.
